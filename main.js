...
function main() {
	...
	switch(id) {
		...
		case 'zoneMain.selectInput':
			...
			sendRequest(obj.common.states, state);
		    });
		    break;
		...
		case 'settings.subwooferLevel':
		    sendRequest('?SW_CLV<CR>');
		    break;
		case 'settings.subwooferLevelDown':
		    sendRequest('SW_48CLV<CR>');
		    break;
		case 'settings.subwooferLevelUp':
		    sendRequest('SW_52CLV<CR>');
		    break;
    ...
    */
    function connect() {
        ...
        adapter.log.info('Trying to connect to ' + host + ':8102');
        connectingVar = null;
        client.connect({port: 8102, host: host});
    } // endConnect
